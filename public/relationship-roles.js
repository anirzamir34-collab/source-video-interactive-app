...
const definitions = [
  ...
  ['kayınvalidesi', 'kayınvalide', 'kayın valide', 'kaynana', 'kaynanası', 'kayınana', 'kayın ana', 'mother-in-law'],
  ['kayınpederi', 'kayınpeder', 'kayın peder', 'kayınbaba', 'kayın baba', 'kayınbabası', 'father-in-law'],
